// Unchanged from step 11's whole-frame post-process blur. Step 12 reuses
// this exact shader for a different job: it's now dispatched repeatedly
// (see BloomBlurIterations in App.cpp) over just the bright pixels that
// BrightPass.hlsl extracted, spreading them into a soft bloom halo instead
// of blurring the entire final image.
